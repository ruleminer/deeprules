...
class AttributesRelationsConditionsGenerator(AbstractConditionsGenerator):
    ...
    def __init__(
        ...
        self.possible_conditions.extend(
            self._generate_for_nominal_attributes())
        self.possible_conditions.extend(
            self._generate_for_numerical_attributes())
    ...
    def _generate_for_nominal_attributes(self) -> list[AbstractCondition]:
        ...
        domain_gruped_attributes: dict[frozenset[str],
                                       list[int]] = defaultdict(lambda: [])

...
from decision_rules.serialization._core.conditions import _AttributesConditionSerializer
from decision_rules.serialization._core.conditions import _BaseConditionModel
from decision_rules.serialization._core.conditions import _BaseConditionSerializer
from decision_rules.serialization._core.conditions import _CompoundConditionSerializer
from decision_rules.serialization._core.conditions import _ConditionSerializer
from decision_rules.serialization._core.conditions import _ElementaryConditionSerializer
from decision_rules.serialization._core.conditions import _NominalConditionSerializer
...
class _NominalAttributesEqualityConditionSerializer(
    ...
    @staticmethod
    def _to_pydantic_model(
        instance: DiscreteSetCondition, **kwargs
...
_ConditionSerializer._conditions_types_map = {
    s.condition_type: s for s in _ConditionSerializer._elementary_conditions_serializers
}

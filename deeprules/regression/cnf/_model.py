...
from deeprules.regression.cnf._induction import RuleInducer


class RegressorCNF(BaseModel):
    """Regressor based on  Rules algorithm. It produces DNF rules in the following
    form:
